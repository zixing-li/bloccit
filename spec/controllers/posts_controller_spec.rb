...
RSpec.describe PostsController, type: :controller do
  ...
  describe 'POST create' do
    it 'increased the number of Post by 1' do
      expect{post :create, params: { topic_id: my_topic.id, post: {name: RandomData.random_sentence, description: RandomData.random_paragraph}}}.to change(Post,:count).by(1)
    end

    it 'assigns the new post to @post' do
      post :create, params: {topic_id: my_topic.id, post: {name: RandomData.random_sentence, description: RandomData.random_paragraph}}
